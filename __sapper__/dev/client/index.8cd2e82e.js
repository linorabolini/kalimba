...
function instance($$self, $$props, $$invalidate) {
	let MyComponent;
  onMount(async () => {
    const module = await import('./Kalimba.96122f34.js');
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h1, "class", "svelte-1st0ezj");
			add_location(h1, file, 23, 0, 352);
		},
