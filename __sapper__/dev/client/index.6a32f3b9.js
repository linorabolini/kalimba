...
function instance($$self, $$props, $$invalidate) {
	let MyComponent;
  onMount(async () => {
    const module = await import('./Kalimba.3f1591a2.js');
