...
const KalimbaSSR = index.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	let MyComponent;
  index.onMount(async () => {
    const module = await new Promise(function (resolve) { resolve(require('./Kalimba-ef158f7f.js')); });
...
const css = {
	code: "h1.svelte-lr5vzq{font-size:2.8em;text-transform:uppercase;font-weight:700;margin:0 0 0.5em 0}@media(min-width: 480px){h1.svelte-lr5vzq{font-size:4em}}",
	map: "{\"version\":3,\"file\":\"index.svelte\",\"sources\":[\"index.svelte\"],\"sourcesContent\":[\"<script>\\n  import KalimbaSSR from \\\"../components/KalimbaSSR.svelte\\\";\\n</script>\\n\\n<style>\\n  h1 {\\n    font-size: 2.8em;\\n    text-transform: uppercase;\\n    font-weight: 700;\\n    margin: 0 0 0.5em 0;\\n  }\\n\\n  @media (min-width: 480px) {\\n    h1 {\\n      font-size: 4em;\\n    }\\n  }\\n</style>\\n\\n<svelte:head>\\n  <title>Sapper project template</title>\\n</svelte:head>\\n\\n<h1>Kalimba</h1>\\n\\n<KalimbaSSR />\\n\"],\"names\":[],\"mappings\":\"AAKE,EAAE,cAAC,CAAC,AACF,SAAS,CAAE,KAAK,CAChB,cAAc,CAAE,SAAS,CACzB,WAAW,CAAE,GAAG,CAChB,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,KAAK,CAAC,CAAC,AACrB,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,EAAE,cAAC,CAAC,AACF,SAAS,CAAE,GAAG,AAChB,CAAC,AACH,CAAC\"}"
};
...
const Index = index.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<h1 class="svelte-lr5vzq">Kalimba</h1>
