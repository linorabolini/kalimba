...
function instance($$self, $$props, $$invalidate) {
	let MyComponent;
  onMount(async () => {
    const module = await import('./Kalimba.7cbf12c1.js');
